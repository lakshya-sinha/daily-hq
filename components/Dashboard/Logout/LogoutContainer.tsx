...
export default function LogoutContainer({open}: any) {
    ...
    <>
        ...
        transition: "transform 0.3s ease",
            ...
            <div className="logout-button-container flex gap-2 items-center justify-center mt-2 p-4">
              ...
              <button className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-green-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5 rounded-lg transition-all cursor-pointer border border-gray-400" onClick={()=> {open = false}}>No</button>
            </div>
            </div>        
    </>
  );
